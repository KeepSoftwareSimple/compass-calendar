...
export const globalHandlers = [
  ...
  http.post(`${ENV_WEB.API_BASEURL}/session/refresh`, () => {
    ...
    headers.append("Set-Cookie", `sAccessToken=${accessToken}`);
    headers.append("Set-Cookie", `sFrontendToken=${frontToken}`);
    headers.append("Set-Cookie", `sRefreshToken=${refreshToken}`);
