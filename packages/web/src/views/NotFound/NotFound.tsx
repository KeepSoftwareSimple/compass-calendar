...
// Snapshot of getPublicShortcutCatalog(), inlined in this boot module so the
// public page does not add a chunk or an import() root (#3704). Keep in sync
// via shortcuts.menu.test.ts.
const catalog = [
  {
    id: "navigate",
    title: "Navigate",
    shortcuts: [
      ...
      { id: "nav-next", keys: ["k"], label: "Next week", section: "navigate" },
      {
        id: "nav-shift-left",
        keys: ["Shift", "j"],
  ...
  },
  {
    ...
    shortcuts: [
      ...
      },
      {
        id: "edit-focus-prev",
        keys: ["ArrowUp"],
        label: "Focus previous event on day",
        section: "edit",
      },
      {
        id: "edit-focus-next",
        keys: ["ArrowDown"],
        label: "Focus next event on day",
        section: "edit",
      },
      {
        id: "edit-focus-left",
...
export const NotFoundView = () => {
  const isShortcutsPage = window.location.pathname === ROOT_ROUTES.SHORTCUTS;

  useEffect(() => {
    if (!isShortcutsPage) return;
